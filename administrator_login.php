                ...
                <div class="row h-100 align-items-center justify-content-center">
                    <div class="col-lg-6 py-5">
                        <div class="rounded p-5 my-5" style="background: rgba(55, 55, 63, .7);">
                            <h1 class="text-center text-white mb-4">Administrator Sign In</h1>
                            <form>
                                ...
                                <p style="text-align: center; margin-top: 20px;">Do not have an account?<a href="administrator_reg.php">Create one</a></p>
